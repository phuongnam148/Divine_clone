...
<div class="container  my-2 ">
        <div class="row row-eq-height ">
            <div class="col-3 col-lg-2 rounded">
                ...
                <li class=""><a href="danhmuc.php?quanly=danhmucsanpham&id=<?php echo $row_danhmuc['id_danhmuc']?>"><?php echo $row_danhmuc['tendanhmuc']?></a></li>
        ...
        <div class="card-deck row my-3">
                <?php while($row_pro = mysqli_fetch_array($query_pro)){
                    ...
                    <div class="col-lg-3 col-md-6 col-12 my-2">
                        ...
                        <form method="POST" action="xulygiohang.php?idsanpham=<?php echo $row_pro['id_sp'] ?>" >              
                            ...
                            <input type="submit" name="addCart" id="addCart<?php echo $row_pro['id_sp'] ?>" value="" type="hidden">
