...
<div class="container my-4" >
    ...
    <?php 
        if(isset($_SESSION['dangnhap'])){
            echo "Xin chào <strong>".$_SESSION['dangnhap']."</strong>";
    ?>    
    ...
    <div class="card" style="min-height: 700px;">
        <div class="row m-2 ">
                    ...
                    <div class="m-2 row border p-2 rounded cart-block">
                        ...
                        <div class="w-100"></div>
                            <div class="col-lg-8 ml-md-auto">
                                ...
                                <a href="?action=cart&xoa=<?php echo $_SESSION['giohang'][$i]['id'];?>" style="color: red; float: right;" onclick="return confirm('Xác nhận xóa sản phẩm')"><i class="fa fa-trash-alt"></i></a>
                            </div>
            ...
            <div class="col p-3 mt-2">
                ...
                ?> 
                    <a href="pages/thanhtoan.php" class="btn btn-primary btn-block rounded py-3" style="font-size: 20px;">
                        <i class="fa fa-dragon mx-2" ></i>Thanh toán</button>
                    </a> 
                <?php 
                }
